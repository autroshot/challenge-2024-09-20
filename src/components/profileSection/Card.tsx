export default function Card({ imageSrc, title, description }: Props) {
    return (
        <div>
            ...
            <h2 className="mt-10 font-montserrat text-2xl font-bold leading-9">{title}</h2>
            <p className="mt-6 font-montserrat text-lg leading-[1.875rem] text-[#000000cc]">{description}</p>
            <button className="mt-6 font-exo-2 text-lg font-bold leading-[1.875rem] text-[#18a0fb] hover:underline">
                LEARN MORE
            </button>
        </div>
    );
